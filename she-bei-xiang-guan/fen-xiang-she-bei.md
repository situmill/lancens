...
* 接口请求:curl -X PUT "[https://weixin.lancens.com:6443/v1/api/device/share/name/XXX](https://weixin.lancens.com:6443/v1/api/device/share/name/XXX)" -H  "accept: application/json" -H  "content-type: application/json" -d "{  \"remarkname\": \"string\"}"
* 接口相关说明:根据XXXuid 更新分享设备表remarkname是设备的备注名称
